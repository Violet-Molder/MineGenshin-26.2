...
public class ArtifactMainStatConfig {
    ...
    public static void register(ModConfigSpec.Builder builder) {
        ...
        WEIGHT_SANDS_HP_PERCENT = builder.defineInRange("max-hp", 26.68, 0.0, 100.0);
        WEIGHT_SANDS_ATK_PERCENT = builder.defineInRange("atk", 26.66, 0.0, 100.0);
        WEIGHT_SANDS_DEF_PERCENT = builder.defineInRange("def", 26.66, 0.0, 100.0);
        WEIGHT_SANDS_EM_FLAT = builder.defineInRange("elemental-mastery", 10.0, 0.0, 100.0);
        WEIGHT_SANDS_ER_PERCENT = builder.defineInRange("energy-recharge", 10.0, 0.0, 100.0);
        builder.pop();

        // --- 空之杯 ---
        builder.push("weightGoblet");
        WEIGHT_GOBLET_HP_PERCENT = builder.defineInRange("max-hp", 21.25, 0.0, 100.0);
        WEIGHT_GOBLET_ATK_PERCENT = builder.defineInRange("atk", 21.25, 0.0, 100.0);
        WEIGHT_GOBLET_DEF_PERCENT = builder.defineInRange("def", 20.0, 0.0, 100.0);
        WEIGHT_GOBLET_PYRO_PERCENT = builder.defineInRange("pyro-bonus", 5.0, 0.0, 100.0);
        WEIGHT_GOBLET_HYDRO_PERCENT = builder.defineInRange("hydro-bonus", 5.0, 0.0, 100.0);
        WEIGHT_GOBLET_CYRO_PERCENT = builder.defineInRange("cyro-bonus", 5.0, 0.0, 100.0);
        WEIGHT_GOBLET_ELECTRO_PERCENT = builder.defineInRange("electro-bonus", 5.0, 0.0, 100.0);
        WEIGHT_GOBLET_ANEMO_PERCENT = builder.defineInRange("anemo-bonus", 5.0, 0.0, 100.0);
        WEIGHT_GOBLET_GEO_PERCENT = builder.defineInRange("geo-bonus", 5.0, 0.0, 100.0);
        WEIGHT_GOBLET_DENDRO_PERCENT = builder.defineInRange("dendro-bonus", 5.0, 0.0, 100.0);
        WEIGHT_GOBLET_PHYSICAL_PERCENT = builder.defineInRange("physical-bonus", 5.0, 0.0, 100.0);
        WEIGHT_GOBLET_EM_FLAT = builder.defineInRange("elemental-mastery", 2.5, 0.0, 100.0);
        builder.pop();

        // --- 理之冠 ---
        builder.push("weightCirclet");
        WEIGHT_CIRCLET_HP_PERCENT = builder.defineInRange("max-hp", 22.0, 0.0, 100.0);
        WEIGHT_CIRCLET_ATK_PERCENT = builder.defineInRange("atk", 22.0, 0.0, 100.0);
        WEIGHT_CIRCLET_DEF_PERCENT = builder.defineInRange("def", 22.0, 0.0, 100.0);
        WEIGHT_CIRCLET_CR_PERCENT = builder.defineInRange("crit-rate", 10.0, 0.0, 100.0);
        WEIGHT_CIRCLET_CDG_PERCENT = builder.defineInRange("crit-dmg", 10.0, 0.0, 100.0);
        WEIGHT_CIRCLET_HB_PERCENT = builder.defineInRange("healing-bonus", 10.0, 0.0, 100.0);
        WEIGHT_CIRCLET_EM_FLAT = builder.defineInRange("elemental-mastery", 4.0, 0.0, 100.0);
        builder.pop();
