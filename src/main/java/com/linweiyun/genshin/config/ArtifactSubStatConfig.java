...
public class ArtifactSubStatConfig {
    ...
    public static ModConfigSpec.ConfigValue<List<? extends String>> SUB_5_ATK_PERCENT;
    public static ModConfigSpec.ConfigValue<List<? extends String>> SUB_5_MAX_HP_PERCENT;
    public static ModConfigSpec.ConfigValue<List<? extends String>> SUB_5_DEF_PERCENT;
    public static ModConfigSpec.ConfigValue<List<? extends Number>> SUB_5_EM_FLAT;
    public static ModConfigSpec.ConfigValue<List<? extends String>> SUB_5_ER_PERCENT;
    public static ModConfigSpec.ConfigValue<List<? extends String>> SUB_5_CR_PERCENT;
    public static ModConfigSpec.ConfigValue<List<? extends String>> SUB_5_CDG_PERCENT;
