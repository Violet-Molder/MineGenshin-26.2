...
public class FieldTalismanSpiritRender extends EntityRenderer<TalismanSpiritArea, ExperienceOrbRenderState> {
  ...
  public void extractRenderState(TalismanSpiritArea entity, ExperienceOrbRenderState state, float partialTicks) {
