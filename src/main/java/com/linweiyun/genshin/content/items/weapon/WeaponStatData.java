...
public class WeaponStatData {
    ...
    private static double sub5_44(String sub) { 
        return switch (sub) { 
            case "crit-rate" -> WeaponSubStatConfig.SUB_5_TIER44_CRIT_RATE.get(); 
            case "crit-dmg" -> WeaponSubStatConfig.SUB_5_TIER44_CRIT_DMG.get(); 
            case "energy-recharge" -> WeaponSubStatConfig.SUB_5_TIER44_ENERGY_RECHARGE.get(); 
            case "atk" -> WeaponSubStatConfig.SUB_5_TIER44_ATK_PERCENT.get(); 
            case "physical-bonus" -> WeaponSubStatConfig.SUB_5_TIER44_PHYSICAL_PERCENT.get(); 
            case "hp" -> WeaponSubStatConfig.SUB_5_TIER44_HP_PERCENT.get(); 
            case "elemental-mastery" -> WeaponSubStatConfig.SUB_5_TIER44_ELEMENTAL_MASTERY.get(); 
            default -> 0.0; 
        }; 
    }
    private static double sub5_46(String sub) { 
        return switch (sub) { 
            case "crit-rate" -> WeaponSubStatConfig.SUB_5_TIER46_CRIT_RATE.get(); 
            case "crit-dmg" -> WeaponSubStatConfig.SUB_5_TIER46_CRIT_DMG.get(); 
            case "energy-recharge" -> WeaponSubStatConfig.SUB_5_TIER46_ENERGY_RECHARGE.get(); 
            case "atk" -> WeaponSubStatConfig.SUB_5_TIER46_ATK_PERCENT.get(); 
            case "physical-bonus" -> WeaponSubStatConfig.SUB_5_TIER46_PHYSICAL_PERCENT.get(); 
            case "hp" -> WeaponSubStatConfig.SUB_5_TIER46_HP_PERCENT.get(); 
            case "elemental-mastery" -> WeaponSubStatConfig.SUB_5_TIER46_ELEMENTAL_MASTERY.get(); 
            default -> 0.0; 
        }; 
    }
    private static double sub5_48(String sub) { 
        return switch (sub) { 
            case "crit-rate" -> WeaponSubStatConfig.SUB_5_TIER48_CRIT_RATE.get(); 
            case "crit-dmg" -> WeaponSubStatConfig.SUB_5_TIER48_CRIT_DMG.get(); 
            case "energy-recharge" -> WeaponSubStatConfig.SUB_5_TIER48_ENERGY_RECHARGE.get(); 
            case "atk" -> WeaponSubStatConfig.SUB_5_TIER48_ATK_PERCENT.get(); 
            case "physical-bonus" -> WeaponSubStatConfig.SUB_5_TIER48_PHYSICAL_PERCENT.get(); 
            case "hp" -> WeaponSubStatConfig.SUB_5_TIER48_HP_PERCENT.get(); 
            case "elemental-mastery" -> WeaponSubStatConfig.SUB_5_TIER48_ELEMENTAL_MASTERY.get(); 
            default -> 0.0; 
        }; 
    }
    private static double sub5_49(String sub) { 
        return switch (sub) { 
            case "crit-rate" -> WeaponSubStatConfig.SUB_5_TIER49_CRIT_RATE.get(); 
            case "crit-dmg" -> WeaponSubStatConfig.SUB_5_TIER49_CRIT_DMG.get(); 
            case "energy-recharge" -> WeaponSubStatConfig.SUB_5_TIER49_ENERGY_RECHARGE.get(); 
            case "atk" -> WeaponSubStatConfig.SUB_5_TIER49_ATK_PERCENT.get(); 
            case "physical-bonus" -> WeaponSubStatConfig.SUB_5_TIER49_PHYSICAL_PERCENT.get(); 
            case "elemental-mastery" -> WeaponSubStatConfig.SUB_5_TIER49_ELEMENTAL_MASTERY.get(); 
            default -> 0.0; 
        }; 
    }

    private static double sub4_41(String sub) { 
        return switch (sub) { 
            case "crit-rate" -> WeaponSubStatConfig.SUB_4_TIER41_CRIT_RATE.get(); 
            case "crit-dmg" -> WeaponSubStatConfig.SUB_4_TIER41_CRIT_DMG.get(); 
            case "energy-recharge" -> WeaponSubStatConfig.SUB_4_TIER41_ENERGY_RECHARGE.get(); 
            case "atk" -> WeaponSubStatConfig.SUB_4_TIER41_ATK_PERCENT.get(); 
            case "physical-bonus" -> WeaponSubStatConfig.SUB_4_TIER41_PHYSICAL_PERCENT.get(); 
            case "elemental-mastery" -> WeaponSubStatConfig.SUB_4_TIER41_ELEMENTAL_MASTERY.get(); 
            default -> 0.0; 
        }; 
    }
    private static double sub4_42(String sub) { 
        return switch (sub) { 
            case "crit-rate" -> WeaponSubStatConfig.SUB_4_TIER42_CRIT_RATE.get(); 
            case "crit-dmg" -> WeaponSubStatConfig.SUB_4_TIER42_CRIT_DMG.get(); 
            case "energy-recharge" -> WeaponSubStatConfig.SUB_4_TIER42_ENERGY_RECHARGE.get(); 
            case "atk" -> WeaponSubStatConfig.SUB_4_TIER42_ATK_PERCENT.get(); 
            case "physical-bonus" -> WeaponSubStatConfig.SUB_4_TIER42_PHYSICAL_PERCENT.get(); 
            case "elemental-mastery" -> WeaponSubStatConfig.SUB_4_TIER42_ELEMENTAL_MASTERY.get(); 
            default -> 0.0; 
        }; 
    }
    private static double sub4_44(String sub) { 
        return switch (sub) { 
            case "crit-rate" -> WeaponSubStatConfig.SUB_4_TIER44_CRIT_RATE.get(); 
            case "crit-dmg" -> WeaponSubStatConfig.SUB_4_TIER44_CRIT_DMG.get(); 
            case "energy-recharge" -> WeaponSubStatConfig.SUB_4_TIER44_ENERGY_RECHARGE.get(); 
            case "atk" -> WeaponSubStatConfig.SUB_4_TIER44_ATK_PERCENT.get(); 
            case "physical-bonus" -> WeaponSubStatConfig.SUB_4_TIER44_PHYSICAL_PERCENT.get(); 
            case "elemental-mastery" -> WeaponSubStatConfig.SUB_4_TIER44_ELEMENTAL_MASTERY.get(); 
            default -> 0.0; 
        }; 
    }
    private static double sub4_45(String sub) { 
        return switch (sub) { 
            case "crit-rate" -> WeaponSubStatConfig.SUB_4_TIER45_CRIT_RATE.get(); 
            case "crit-dmg" -> WeaponSubStatConfig.SUB_4_TIER45_CRIT_DMG.get(); 
            case "energy-recharge" -> WeaponSubStatConfig.SUB_4_TIER45_ENERGY_RECHARGE.get(); 
            case "atk" -> WeaponSubStatConfig.SUB_4_TIER45_ATK_PERCENT.get(); 
            case "physical-bonus" -> WeaponSubStatConfig.SUB_4_TIER45_PHYSICAL_PERCENT.get(); 
            case "elemental-mastery" -> WeaponSubStatConfig.SUB_4_TIER45_ELEMENTAL_MASTERY.get(); 
            default -> 0.0; 
        }; 
    }

    private static double sub3_38(String sub) { 
        return switch (sub) { 
            case "crit-rate" -> WeaponSubStatConfig.SUB_3_TIER38_CRIT_RATE.get(); 
            case "crit-dmg" -> WeaponSubStatConfig.SUB_3_TIER38_CRIT_DMG.get(); 
            case "energy-recharge" -> WeaponSubStatConfig.SUB_3_TIER38_ENERGY_RECHARGE.get(); 
            case "atk" -> WeaponSubStatConfig.SUB_3_TIER38_ATK_PERCENT.get(); 
            case "physical-bonus" -> WeaponSubStatConfig.SUB_3_TIER38_PHYSICAL_PERCENT.get(); 
            case "elemental-mastery" -> WeaponSubStatConfig.SUB_3_TIER38_ELEMENTAL_MASTERY.get(); 
            default -> 0.0; 
        }; 
    }
    private static double sub3_39(String sub) { 
        return switch (sub) { 
            case "crit-rate" -> WeaponSubStatConfig.SUB_3_TIER39_CRIT_RATE.get(); 
            case "crit-dmg" -> WeaponSubStatConfig.SUB_3_TIER39_CRIT_DMG.get(); 
            case "energy-recharge" -> WeaponSubStatConfig.SUB_3_TIER39_ENERGY_RECHARGE.get(); 
            case "atk" -> WeaponSubStatConfig.SUB_3_TIER39_ATK_PERCENT.get(); 
            case "physical-bonus" -> WeaponSubStatConfig.SUB_3_TIER39_PHYSICAL_PERCENT.get(); 
            case "elemental-mastery" -> WeaponSubStatConfig.SUB_3_TIER39_ELEMENTAL_MASTERY.get(); 
            default -> 0.0; 
        }; 
    }
    private static double sub3_40(String sub) { 
        return switch (sub) { 
            case "crit-rate" -> WeaponSubStatConfig.SUB_3_TIER40_CRIT_RATE.get(); 
            case "crit-dmg" -> WeaponSubStatConfig.SUB_3_TIER40_CRIT_DMG.get(); 
            case "energy-recharge" -> WeaponSubStatConfig.SUB_3_TIER40_ENERGY_RECHARGE.get(); 
            case "atk" -> WeaponSubStatConfig.SUB_3_TIER40_ATK_PERCENT.get(); 
            case "physical-bonus" -> WeaponSubStatConfig.SUB_3_TIER40_PHYSICAL_PERCENT.get(); 
            case "elemental-mastery" -> WeaponSubStatConfig.SUB_3_TIER40_ELEMENTAL_MASTERY.get(); 
            default -> 0.0; 
        }; 
    }
    ...
    public static double getSubStatValue(int star, int tier, AttributeType subStatType, int level) {
        ...
        double mult = WeaponLevelData.getSubStatMultiplier(level);
        return base * mult;
    }
}