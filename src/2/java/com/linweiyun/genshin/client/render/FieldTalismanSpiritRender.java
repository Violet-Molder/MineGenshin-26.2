...
@OnlyIn(Dist.CLIENT)
public class FieldTalismanSpiritRender extends EntityRenderer<FieldTalismanSpirit> {
  ...
  protected int getBlockLightLevel(@NotNull FieldTalismanSpirit entity, @NotNull BlockPos pos) {
    return Mth.clamp(super.getBlockLightLevel(entity, pos) + 7, 0, 15);
  }

  public void render(
      FieldTalismanSpirit entity,
      float entityYaw,
      float partialTicks,
      PoseStack poseStack,
  ...
  public @NotNull ResourceLocation getTextureLocation(@NotNull FieldTalismanSpirit entity) {
