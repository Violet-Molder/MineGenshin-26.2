...
@OnlyIn(Dist.CLIENT)
public class ElementalOrbRender extends EntityRenderer<ElementalOrb> {
  ...
  public ElementalOrbRender(EntityRendererProvider.Context context) {
    super(context);
    this.shadowRadius = 0.15F;
    this.shadowStrength = 0.75F;
  }

  protected int getBlockLightLevel(@NotNull ElementalOrb entity, @NotNull BlockPos pos) {
  ...
  public void render(
      ...
      int packedLight) {
    poseStack.pushPose();
    float f = (float) (4 * 16) / 64.0F;
    float f1 = (float) (4 * 16 + 16) / 64.0F;
    float f2 = (float) (4 * 16) / 64.0F;
    float f3 = (float) (4 * 16 + 16) / 64.0F;
    float f4 = 1.0F;
    float f5 = 0.5F;
    float f6 = 0.25F;
    float f7 = 255.0F;
  ...
  public @NotNull ResourceLocation getTextureLocation(@NotNull ElementalOrb entity) {
